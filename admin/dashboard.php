        ...
        <div class="header">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    ...
                    <span><img src="images/icn1.png" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
...
*/ -->
            <div style="padding-top: 10px;">
                <marquee onMouseOver="this.stop()" onMouseOut="this.start()">SHRISHA is the sole owner of this script. It is not for sale or reuse. For any of your problems contact me on +91 9980216005. </marquee>
            </div>
